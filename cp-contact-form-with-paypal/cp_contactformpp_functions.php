...
function _cp_contactformpp_install() {
    ...
    $sql = "CREATE TABLE IF NOT EXISTS ".$wpdb->prefix.CP_CONTACTFORMPP_POSTS_TABLE_NAME_NO_PREFIX." (
    ...
    $sql = "CREATE TABLE IF NOT EXISTS ".$wpdb->prefix.CP_CONTACTFORMPP_DISCOUNT_CODES_TABLE_NAME_NO_PREFIX." (
         id mediumint(9) NOT NULL AUTO_INCREMENT,
