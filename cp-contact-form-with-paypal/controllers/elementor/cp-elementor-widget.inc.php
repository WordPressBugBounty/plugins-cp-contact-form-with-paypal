...
{    
    class CP_ContactFormwPayPal_Elementor {
      ...
      private $prefix = 'cp_contactformpp';           
      ...
      function enqueue_editor_styles() {
         // wp_enqueue_style('cfwpp-editor-styles', plugins_url('/elementor_icon.css', __FILE__), array(), '1.0.0');
      }
      ...
      function enqueue_frontend_styles() {
          ...
          wp_enqueue_script( $this->prefix.'_builder_script',
                 plugins_url('/../../js/fbuilder.jquery.js?nc=2', __FILE__),array("jquery","jquery-ui-core","jquery-ui-datepicker","jquery-ui-widget","jquery-ui-position","jquery-ui-tooltip",$this->prefix."_validate_script"), false, true );          
      }      
